...
var LDAvis = function(to_select, data_or_file_name) {
    ...
    function visualize(data) {
        ...
        var points = mdsplot.selectAll("points")
                .data(mdsData)
                .enter();
        var topicnames = {1 : "Törvényalkotás",
                         2 : "Pártpolitika",
                         3 : "Alkotmány, stb.",
                         4 : "Gazdaság, stb.",
                         5 : "Gazdaság, nyugdíj",
                         ...
                         7 : "EU",
                         8: "Külpolitika stb.",
                         9: "Bíróság, rendőrség, stb",
                         10: "Önkormányzatiság",
                         11: "Pénzügyek",
                         12: "Gazdaság, pénzügy",
                         13: "Családpolitika",
                         14: "Honvédelem",
                         15: "Földművelés, vidékfejlesztés",
                         16: "Egészségpolitika",
                         17: "Parlamenti vita",
                         18: "Szavazás",
                         19: "Törvényalkotás 2."};
...
//            .style("text-anchor", "middle");
        ...
        d3.select("#" + barFreqsID).append("text")
            ...
            .text("Gyakoriság a teljes korpuszban");
        ...
        d3.select("#" + barFreqsID).append("text")
            ...
            .style("dominant-baseline", "middle")
            .text("A topikon belüli becsült gyakoriság");
